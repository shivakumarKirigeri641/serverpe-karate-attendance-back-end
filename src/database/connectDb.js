...
/* ============================================
   KARATE ATTENDANCE DB (PGDATABASEKARATEATTENDANCE)
============================================ */
const connectKarateAttendanceDb = () => {
  if (!pool) {
    pool = new Pool({
      host: process.env.PGHOST,
      database: process.env.PGDATABASEKARATEATTENDANCE,
    ...
    testConnection(pool, "Karate attendance database.");
  }
  return pool;
};
